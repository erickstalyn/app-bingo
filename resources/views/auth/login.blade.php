...
<body>
    ...
    <div class="login-content">
        <!-- Login -->
        <form method="POST" action="{{ route('login') }}" class="nk-block toggled">
            {{ csrf_field() }}
            <div class="nk-form">
                <div class="input-group">
                    <span class="input-group-addon nk-ic-st-pro"><i class="notika-icon notika-support"></i></span>
                    <div class="nk-int-st">
                        <input type="text" name="user" class="form-control" value="{{ old('user') }}" placeholder="Nombre de usuario" required autofocus>
                    </div>
                </div>
            ...
            <div class="nk-navigation nk-lg-ic">
                <a href="#" data-ma-action="nk-login-switch" data-ma-block="#l-register"><i class="notika-icon notika-plus-symbol"></i><span>Ir  al inicio</span></a>
            </div>
        </form>
